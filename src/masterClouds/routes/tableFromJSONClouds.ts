...
import { registerTableFromJSON, deleteTableFromJSON, getAllTableFromJSON, getTableFromJSONById, updateTableFromJSON } from '../controllers/tableFromJSONControllers';
